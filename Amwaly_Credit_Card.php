<?php
/*
Plugin Name: By Credit Card
Description: Use this woocommerce payment gateway plugin to enable clients of your store to pay using By Credit Card gateway.
Version: 1.0
Author: Amwaly io
text-domain:  By Credit Card
Plugin URI: https://github.com/amwaly/Amwaly_Credit_Card
*/
...
public function __construct(){
    ...
    $Amwaly_ICON        = 'https://amwaly.io/visalogo.png';
    $Amwaly_NAME        = 'By Credit Card';
    $Amwaly_DESCRIPTION = 'Gateway support all Payment methods ( Credit Cards )';
...
$this->add_error(__("<span style='color:red;font-weight: bold'>By Credit Card Done </b>", 'amwaly'));
$this->display_errors();
}
}
